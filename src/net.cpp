...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cakecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.cakecoin.info", "seed1.cakecoin.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"test-seed1.cakecoin.info", "test-seed1.cakecoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cakecoin is probably already running."), addrBind.ToString().c_str());
        else
